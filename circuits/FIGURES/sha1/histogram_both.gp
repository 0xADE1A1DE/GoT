...
#median_height=0.263 + offset_from_median_height
median_height=get_median_height(NOPREF_median, "final_prefetch_disabled.csv")
print(NOPREF_median)
print(median_height)


set arrow from bin(NOPREF_median, binwidth), median_height + 0.04 to bin(NOPREF_median, binwidth), median_height lw 10

set label at bin(NOPREF_median, binwidth) - 0.185, median_height + 0.04 + 0.005 "Median (PD)" font "helvetica, 48"

#normal_median_height=0.023
normal_median_height=get_median_height(NORMAL_median, "final_prefetch_enabled.csv")

set arrow from bin(NORMAL_median, binwidth), normal_median_height + 0.04 to bin(NORMAL_median, binwidth), normal_median_height lw 10

set label at bin(NORMAL_median, binwidth) - 0.105, normal_median_height + 0.04 + 0.015 "Median (PE)" font "helvetica, 48"
