...
#set label at 0.015,0.055  sprintf("Samples: %d\nMean: %f\nMedian: %f", STATS_records, STATS_mean, STATS_median);

offset_from_median_height=0.0

median_height=0.037 + offset_from_median_height

set arrow from bin(STATS_median, binwidth), median_height + 0.01 to bin(STATS_median, binwidth), median_height lw 10

set label at bin(STATS_median, binwidth) - 0.059, median_height + 0.01 + 0.003 "Median" font "helvetica, 48"
