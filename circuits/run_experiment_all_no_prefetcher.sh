...
echo "" > PREFETCH
mkdir -pv $1/SHA1_NO_PREFETCH

./run_experiment_pipe_auto.sh $1/SHA1_NO_PREFETCH 0 sha1 0 $(cat REP)

mkdir -pv $1/SHA1_NO_PREFETCH/RESULT

cat $1/SHA1_NO_PREFETCH/* | grep "SHA1 Acc*" | grep "(.*)" -o | sed "s/(//g" | sed "s/)//g" > $1/SHA1_NO_PREFETCH/RESULT/all.csv
cat $1/SHA1_NO_PREFETCH/RESULT/all.csv | datamash median 1 > $1/SHA1_NO_PREFETCH/RESULT/ALL_MEDIAN
cat $1/SHA1_NO_PREFETCH/RESULT/all.csv | datamash mean 1 > $1/SHA1_NO_PREFETCH/RESULT/ALL_MEAN

cat $1/SHA1_NO_PREFETCH/* | grep "SHA1 Acc*" | grep "(.*)" -o | sed "s/(//g" | sed "s/)//g" | shuf -n 10000 > $1/SHA1_NO_PREFETCH/RESULT/final.csv
cat $1/SHA1_NO_PREFETCH/RESULT/final.csv | datamash median 1 > $1/SHA1_NO_PREFETCH/RESULT/FINAL_MEDIAN
cat $1/SHA1_NO_PREFETCH/RESULT/final.csv | datamash mean 1 > $1/SHA1_NO_PREFETCH/RESULT/FINAL_MEAN
