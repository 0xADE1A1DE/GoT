...
public:
    ...
    uint64_t apply(GateBank *bank, uint64_t trash) const final {
        static GateBank __attribute__((aligned(128))) fake = { .inputs = {(uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake, (uintptr_t)&fake}, .outputs = {0} };
